    ...
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        { 
            ...
            try
            {
                ...
                SqlCommand sql = new SqlCommand("INSERT INTO USERS (number, username, email,dob, password) VALUES(@number,@username,@email,@dob,@password)", con);
                sql.Parameters.AddWithValue("@username",usernameIn.Text);
                sql.Parameters.AddWithValue("@number", numberIn.Text);
